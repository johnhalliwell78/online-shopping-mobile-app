...
public class InformationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng shop = new LatLng(10.831376, 106.668673 );
        mMap.addMarker(new MarkerOptions().position(shop).title("Marker in Shop").snippet("417 Quang Trung").icon(BitmapDescriptorFactory.defaultMarker()));
