...
import day03.giangth.onlinemanagement.adapter.PhoneAdapter;
...
//                    listView.removeFooterView(footerView);
                    try {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            namePhone = jsonObject.getString("name");
                            pricePhone = jsonObject.getInt("price");
                            imagePhone = jsonObject.getString("image");
                            desPhone = jsonObject.getString("description");
                            idtype = jsonObject.getInt("idtype");
                            productArrayList.add(new Product(id, namePhone, pricePhone, imagePhone, desPhone, idtype));
...
//                    listView.removeFooterView(footerView);
    ...
    private void direct() {
        toolbar = (android.support.v7.widget.Toolbar) findViewById(R.id.phoneToolbar);
        listView = (ListView) findViewById(R.id.phoneListView);
        productArrayList = new ArrayList<>();
        phoneAdapter = new PhoneAdapter(getApplicationContext(), productArrayList);
